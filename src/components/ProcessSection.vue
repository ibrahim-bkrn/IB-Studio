...
const steps = [
  {
    ...
    icon: '◎',
    tag: 'Découverte',
    title: 'On se comprend avant de coder',
  ...
  },
  {
    ...
    text: 'Avant d\'écrire une ligne de code, je conçois la structure et l\'identité visuelle de votre projet. Vous validez chaque étape.',
  ...
  },
  {
    ...
    icon: '⚡',
    tag: 'Développement',
    title: 'Code propre, performances optimales',
    ...
    items: ['Développement itératif', 'Accès à un environnement de prévisualisation', 'Tests cross-navigateurs et mobile'],
  },
  {
    number: '04',
    icon: '◇',
